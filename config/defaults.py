...
# Which architecture to build: 'promptsg' | 'clip_scgi'
_C.MODEL.METHOD = 'promptsg'
...
# -----------------------------------------------------------------------------
# CLIP-SCGI settings (arXiv:2410.09382)
# -----------------------------------------------------------------------------
_C.MODEL.CLIPSCGI = CN()
# Training uses offline captions; inference drops caption-guided branch.
_C.MODEL.CLIPSCGI.USE_CAPTION = True
_C.MODEL.CLIPSCGI.DROP_CGI_IN_INFER = True
# Contrastive loss temperature (InfoNCE)
_C.MODEL.CLIPSCGI.TEMPERATURE = 0.07
_C.MODEL.CLIPSCGI.LAMBDA_CON = 1.0

# Caption-Guided Inversion (CGI)
_C.MODEL.CLIPSCGI.CGI_NUM_QUERIES = 2
_C.MODEL.CLIPSCGI.CGI_HEADS = 8

# Contextual Feature Fusion (CFF)
_C.MODEL.CLIPSCGI.CFF_HEADS = 8
_C.MODEL.CLIPSCGI.CFF_POST_BLOCKS = 2
_C.MODEL.CLIPSCGI.COATTN_TEXT_MODE = "full"   # "full" | "eot"
_C.MODEL.CLIPSCGI.KV_MODE = "cls_patch"       # "patch" | "cls_patch" | "cls"
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
# Optional: offline captions mapping (for CLIP-SCGI). JSON/CSV supported.
_C.DATASETS.CAPTION_FILE = ''
...
# Optional: evaluation speed knob (PromptSG used to skip MIM for gallery)
_C.TEST.SKIP_MIM_GALLERY = False
